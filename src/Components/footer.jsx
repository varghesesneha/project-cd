    ...
    <footer className={`mb-0 p-4 ${styles.footer}`}>
      <div className="row">
        <div className={`col-12 col-sm-6 col-md-4 ${styles.left}`}>
          <a href="/">
            <img className={`${styles.logo}`} src={logo} alt="DONATE MATE LOGO" />
          </a>
          <br />
          <p className={`${styles.caption}`}>
          THE GIVERS NETWORK <br /> IIITM 
          </p>
        </div>
        ...
        <div className={`col-12 col-sm-12 col-md-4 ${styles.right}`}>
          <p className={`${styles.names}`}>
            ...
            <a
              ...
              href="https://www.linkedin.com/in/sneha-varghese-1b0439298?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
              target="_blank"
              rel="noreferrer"
            >
              Sneha Varghese
      ...
      <div className={`${styles.footerBottom}`}>
        ...
        <p style={{ textAlign: "center" }}>
          Copyright &copy; 2021 GIVERS NETWORK IIITM. All Rights Reserved.
        </p>
      </div>
    </footer>
  );
